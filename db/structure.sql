...
-- Name: rideshare; Type: SCHEMA

CREATE SCHEMA rideshare;

-- Name: vehicle_status; Type: TYPE
...
-- Name: fast_count(text, bigint); Type: FUNCTION
...
-- Name: scrub_email(character varying); Type: FUNCTION
...
-- Name: scrub_text(character varying); Type: FUNCTION
...
-- Name: fast_search_results; Type: MATERIALIZED VIEW
...
-- Name: trip_positions; Type: TABLE
...
-- Name: vehicle_reservations; Type: TABLE
...
-- Name: trips chk_rails_4743ddc2d2; Type: CHECK CONSTRAINT

ALTER TABLE rideshare.trips
    ADD CONSTRAINT chk_rails_4743ddc2d2 CHECK ((completed_at > created_at)) NOT VALID;

-- Name: vehicle_reservations non_overlapping_vehicle_registration; Type: CONSTRAINT
...
-- Name: vehicle_reservations fk_rails_59996232fc; Type: FK CONSTRAINT

ALTER TABLE ONLY rideshare.vehicle_reservations
    ADD CONSTRAINT fk_rails_59996232fc FOREIGN KEY (trip_request_id) REFERENCES rideshare.trip_requests(id);

-- Name: trips fk_rails_6d92acb430; Type: FK CONSTRAINT
...
-- Name: vehicle_reservations fk_rails_7edc8e666a; Type: FK CONSTRAINT

ALTER TABLE ONLY rideshare.vehicle_reservations
    ADD CONSTRAINT fk_rails_7edc8e666a FOREIGN KEY (vehicle_id) REFERENCES rideshare.vehicles(id);

-- Name: trip_positions fk_rails_9688ac8706; Type: FK CONSTRAINT
