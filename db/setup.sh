...
# database
psql $DB_URL -a -f db/create_database_development.sql

# schema
psql $DB_URL -a -f db/create_schema.sql

# grants
psql $DB_URL -a -f db/create_grants_database_development.sql
psql $DB_URL -a -f db/create_grants_schema_development.sql
